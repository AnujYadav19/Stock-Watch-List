...
public class StockController {
    ...
    public ApiResponse<PaginatedResponse<StockResponseDTO>> listStocksPaginated(
        ...
        PaginatedResponse<StockResponseDTO> response = service.getStocks(symbol, page, size, sortBy, direction);
    ...
    public ApiResponse<StockResponseDTO> getStockBySymbol(@RequestParam String symbol) {
        logger.info("GET /stocks/search request received with symbol: {}", symbol);
        StockResponseDTO response = service.findBySymbol(symbol);
        logger.info("GET /stocks/search completed successfully with id:{}", response.getId());
    ...
    public ApiResponse<StockResponseDTO> getStock(@PathVariable int id) {
        ...
        StockResponseDTO response = service.findByIdDTO(id);
    ...
    public ApiResponse<StockResponseDTO> addStock(@Valid @RequestBody StockRequestDTO s) {
        ...
        StockResponseDTO response = service.saveStock(s);
    ...
    public ApiResponse<StockResponseDTO> updateStock(@Valid @RequestBody StockRequestDTO s, @PathVariable int id) {
        ...
        StockResponseDTO response = service.updateStockById(id, s);
    ...
    public ApiResponse<StockResponseDTO> deleteStock(@PathVariable int id) {
        ...
        StockResponseDTO response = service.deleteStockById(id);
